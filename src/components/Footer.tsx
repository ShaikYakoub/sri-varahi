        ...
        <div className="grid grid-cols-3 gap-8 mb-12">
          ...
          <div>
            <a
              ...
              className="w-14 h-14 bg-linear-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] hover:opacity-90 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md mb-2"
            ...
            <span
              className="font-bold text-xl text-blue-600 dark:text-amber-400 mt-2 block"
              style={{
                letterSpacing: "1px",
