// Removed stray <li> element that was breaking JSX
    ...
    <footer className="bg-slate-100 dark:bg-black text-slate-700 dark:text-gray-300 pt-16 pb-8 border-t border-blue-100/50 dark:border-amber-500/20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="hidden md:grid grid-cols-3 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2 mt-2">
              ...
              />
              <span
                className="text-xl font-extrabold bg-linear-to-r from-yellow-300 to-yellow-500 bg-clip-text text-transparent select-none"
                style={{
                  letterSpacing: "1px",
            ...
            <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300 font-light mt-4">
              India&apos;s Redefining{" "}
              ...
              ,<br />
              and value for a new generation of gold
            </p>
        ...
        <div className="md:hidden flex flex-col gap-8 mb-12">
          {/* First Row: Logo/Name/Desc left, Socials right */}
          <div className="flex flex-row justify-between gap-6">
            ...
            <div className="flex-1 flex flex-col items-start min-w-0">
              ...
              <p className="text-xs leading-relaxed text-gray-600 dark:text-gray-300 font-light">
                India&apos;s Redefining{" "}
                <span className="font-semibold text-blue-600 dark:text-amber-400">
                  trust
                </span>
            ...
            {/* Right: Socials */}
            <div className="flex-1 flex flex-col items-start min-w-0">
              <h4 className="text-blue-600 dark:text-amber-400 font-semibold mb-2">
                Socials
              </h4>
              <div className="flex gap-2">
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-linear-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] hover:opacity-90 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md"
                aria-label="Instagram"
              >
                <svg
                  className="w-5 h-5"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-9 h-9 bg-[#1877F2] hover:bg-[#0C63D4] text-white rounded-full flex items-center justify-center hover:scale-110 transition-colors shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-9 h-9 bg-[#FF0000] hover:bg-[#CC0000] text-white rounded-full flex items-center justify-center hover:scale-110 transition-colors shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
          ...
          {/* Second Row: Services left, Contact right */}
          <div className="flex flex-row gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <ul className="space-y-2 text-xs">
                <li className="flex items-center gap-2">
                  <span className="text-blue-600 dark:text-amber-400 text-base">
                    📞
                  </span>
                  <a
                    href="tel:+916262667272"
                ...
                <li className="flex items-start gap-2 pt-2">
                  <span className="text-blue-600 dark:text-amber-400 text-base mt-0.5">
                    📍
                  </span>
                  <a
                    href="https://maps.app.goo.gl/6JrcMYyRwvvjizUs9"
